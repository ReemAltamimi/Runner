...
public class playerSpawner : MonoBehaviour
{
    ...
    public float leftSpawnPosX = 0;               // The x coordinate of position if it's instantiated on the left.
    public float rightSpawnPosX = 0;           // The x coordinate of position if it's instantiated on the right.
    public float minSpawnPosY = 0;              // The lowest possible y coordinate of position.
    public float maxSpawnPosY = 0;             // The highest possible y coordinate of position.
